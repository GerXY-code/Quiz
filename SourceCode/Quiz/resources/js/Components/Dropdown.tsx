...
const Content = ({ align = 'right', width = '48', contentClasses = 'width-32 py-1 bg-blue-300 dark:bg-blue-400 border-solid border-2', children }: PropsWithChildren<{ align?: 'left'|'right', width?: '48', contentClasses?: string }>) => {
